"""Generate out-of-fold (OOF) predictions for raw_face model (story-level CV on training stories)."""
...
try:
    ...
    from raw_face.common import load_config, set_seed
    from raw_face.predict import predict_samples
    from raw_face.train import train_model


def parse_args():
    p = argparse.ArgumentParser(description="Train holdout models and write OOF predictions for raw_face.")
...
def main():
    ...
    for holdout in folds:
        ...
        ckpt_path = ckpt_dir / f"raw_face_3dcnn_holdout_{holdout}.pt"
