"""Generate out-of-fold (OOF) predictions for fullbody model (story-level CV on training stories)."""
...
try:
    ...
    from fullbody.common import load_config, set_seed
    from fullbody.predict import predict_samples
    from fullbody.train import train_model


def parse_args():
    p = argparse.ArgumentParser(description="Train holdout models and write OOF predictions for fullbody.")
